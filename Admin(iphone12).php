...
<body bgcolor="black">
    ...
    <ul>
        <li id="list1"><a href=" ./Admin(iphone14).php"><img src="./iphone14.jpeg" class="navimg"><br>Iphone 14
                Series<a></li>
        <li id="list2"><a href=" ./Admin(iphone13).php"><img src="
                    ./iPhone13.jpeg" class="navimg"><br>Iphone
                13 Series<a></li>
        <li id="list3" style="transform:scale(1.2)"><a style="text-decoration:underline;"
                href="./Admin(iphone12).php"><img src="./iphone12.jpeg" class="navimg"><br>Iphone 12
                Series<a></li>
    </ul>
    <center>
        <form action="" method="POST">
            <table class="anim">
                ...
                <tr>
                    ...
                    <?php
                    $sql = "SELECT * FROM `STOCKS` WHERE NAME = 'IPhone 12 Mini';";
                    ...
                    <td><img src="./12.png" class="grid" style="height: 230px ;"></td>
    ...
    if (isset($_POST['b14'])) {
        ...
        $qty = $val + $i14;
        $sql = "UPDATE STOCKS SET QUANTITY = '$qty' WHERE NAME = 'IPhone 12 Mini'";
        ...
        $qty = $val + $i14plus;
        $sql = "UPDATE STOCKS SET Quantity = '$qty' WHERE NAME = 'IPhone 12'";
        mysqli_query($conn, $sql);
        $qty = 0;
        ...
        $qty = $val + $i14pro;
        $sql = "UPDATE STOCKS SET Quantity = '$qty' WHERE NAME = 'IPhone 12 Pro'";
        mysqli_query($conn, $sql);
        $qty = 0;
        ...
        $qty = $val + $i14promax;
        $sql = "UPDATE STOCKS SET Quantity = '$qty' WHERE NAME = 'IPhone 12 Pro Max'";
        mysqli_query($conn, $sql);
        $qty = 0;
        header("Refresh:0"); 
    }
