...
<body bgcolor="black">
    ...
    <ul>
        <li id="list1" style="transform:scale(1.2)"><a style="text-decoration:underline;"
                href=" ./Admin(iphone14).php"><img src="./iphone14.jpeg" class="navimg"><br>Iphone 14
                Series<a></li>
    ...
    if (isset($_POST['b14'])) {
        ...
        $qty = $val + $i14;
        $sql = "UPDATE STOCKS SET QUANTITY = '$qty' WHERE NAME = 'IPhone 14'";
        ...
        $qty = $val + $i14plus;
        $sql = "UPDATE STOCKS SET Quantity = '$qty' WHERE NAME = 'IPhone 14 Plus'";
        mysqli_query($conn, $sql);
        $qty = 0;
        ...
        $qty = $val + $i14pro;
        $sql = "UPDATE STOCKS SET Quantity = '$qty' WHERE NAME = 'IPhone 14 Pro'";
        mysqli_query($conn, $sql);
        $qty = 0;
        ...
        $qty = $val + $i14promax;
        $sql = "UPDATE STOCKS SET Quantity = '$qty' WHERE NAME = 'IPhone 14 Pro Max'";
        mysqli_query($conn, $sql);
        $qty = 0;
        header("Refresh:0"); 
